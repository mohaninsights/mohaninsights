      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start max-w-6xl mx-auto">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="glass-panel border border-white/5 rounded-2xl p-6 relative overflow-hidden bg-[#070b1e]/60">
              <h3 className="font-display font-bold text-base text-white tracking-wide mb-6">
                Contact Information
              </h3>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    <span className="block font-mono text-[10px] text-gray-500 uppercase">Write Email</span>
                    <span className="font-display text-xs font-semibold text-white group-hover:text-brand-cyan transition-colors">
                ...
                >
                  ...
                  <div>
                    <span className="block font-mono text-[10px] text-gray-500 uppercase">Direct Call</span>
                    <span className="font-display text-xs font-semibold text-white group-hover:text-brand-cyan transition-colors">
                      +91 8585974338
                    </span>
                  </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <span className="block font-mono text-[10px] text-gray-500 uppercase">Operation Hub</span>
            ...
            <div className="glass-panel border border-white/5 rounded-2xl p-6 relative bg-[#070b1e]/60">
              <h3 className="font-display font-bold text-sm text-white tracking-wider uppercase mb-4">
            ...
            <div className="glass-panel border border-white/5 rounded-2xl p-5 relative overflow-hidden bg-[#070b1e]/80 h-[220px]">
              
              {/* Outer map style frame overlay */}
              <div className="absolute inset-0 opacity-20 pointer-events-none" style={{ backgroundImage: "radial-gradient(#ffffff 1px, transparent 1px)", backgroundSize: "18px 18px" }} />
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 text-center p-3 z-10 glass-panel border border-white/10 rounded-xl">
                <span className="block font-mono text-[9px] text-brand-cyan tracking-widest uppercase">MAP OPTIMIZATION</span>
                <span className="block font-display font-bold text-xs text-white mt-0.5">LOCALIZED SEO TARGETS</span>
                <span className="block font-sans text-[10px] text-gray-500 mt-1">Multi-Node Search Reach Mapping</span>
              </div>
          ...
          <div className="lg:col-span-7">
            <div className="glass-panel-heavy border border-white/10 rounded-2xl p-6 sm:p-8 relative bg-[#070b1e]/80 shadow-xl">
              ...
              <AnimatePresence mode="wait">
                {formStatus === "success" ? (
                  ...
                  >
                    ...
                    <p className="font-sans text-xs text-gray-400 mt-3 max-w-md leading-relaxed">
                    ...
                    <button
                      ...
                      className="mt-8 px-6 py-2.5 rounded-full bg-white text-black font-display font-bold text-[11px] tracking-wider uppercase hover:bg-brand-cyan hover:scale-105 transition-all"
                    >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="space-y-1.5">
                        ...
                        <input
                          ...
                          required
                          className="w-full bg-white/[0.02] border border-white/10 rounded-xl px-4 py-3 text-xs text-white focus:border-brand-cyan focus:outline-none focus:bg-white/[0.04] transition-all placeholder:text-gray-600"
                        />
                      </div>
                    ...
                    {/* Website URL Input */}
                    <div className="space-y-1.5">
                      <label className="block font-mono text-[10px] text-gray-400 uppercase tracking-wider flex items-center justify-between">
                        <span>Website URL</span>
                        <span className="text-[9px] text-gray-500 italic lowercase">optional but recommended</span>
                      </label>
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full bg-white/[0.02] border border-white/10 rounded-xl pl-11 pr-4 py-3 text-xs text-white focus:border-brand-cyan focus:outline-none focus:bg-white/[0.04] transition-all placeholder:text-gray-600"
                        />
                      </div>
                    </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        className="w-full bg-[#0a0e23] border border-white/10 rounded-xl px-4 py-3 text-xs text-white focus:border-brand-cyan focus:outline-none transition-all cursor-pointer"
                      >
                        {servicesList.map((service, idx) => (
                          <option key={idx} value={service} className="bg-[#0a0e23] text-white py-2">
                            {service}
                          </option>
                        ))}
                      </select>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <textarea
                        ...
                        className="w-full bg-white/[0.02] border border-white/10 rounded-xl px-4 py-3 text-xs text-white focus:border-brand-cyan focus:outline-none focus:bg-white/[0.04] transition-all placeholder:text-gray-600 resize-none"
                      />
                    </div>
                    ...
                    <div className="pt-2 text-center flex items-center justify-center gap-2 text-[10px] text-gray-500 font-mono">
