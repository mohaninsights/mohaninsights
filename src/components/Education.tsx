        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 max-w-5xl mx-auto">
          {educationData.map((edu, idx) => (
            <motion.div
              ...
              className="glass-panel border border-white/5 hover:border-brand-cyan/20 rounded-2xl p-6 hover:bg-white/[0.04] hover:-translate-y-1.5 transition-all duration-300 flex flex-col justify-between group shadow-md"
            >
              <div>
                {/* Header Badge */}
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="w-8 h-8 rounded-lg bg-white/[0.02] border border-white/5 flex items-center justify-center text-brand-purple group-hover:text-brand-cyan transition-colors">
                    <GraduationCap className="w-4 h-4" />
                  </div>
                </div>

                {/* Degree & Institution */}
                <h3 className="font-display font-bold text-sm text-white tracking-wide group-hover:text-brand-cyan transition-colors duration-300">
                  {edu.degree}
                </h3>
                
                <p className="font-sans text-xs text-gray-400 font-semibold mt-1 flex items-center gap-1">
              ...
              {/* Card Footer Status */}
              <div className="mt-6 pt-4 border-t border-white/[0.05] flex items-center justify-between text-[10px] text-gray-500 font-mono">
